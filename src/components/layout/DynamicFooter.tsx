...
const DynamicFooter = () => {
  ...
  // Separate legal pages by footer section
  const legalLinks = legalPages.filter(p => p.show_in_footer && p.footer_section === 'legal');
  const partnerLinks = legalPages.filter(p => p.show_in_footer && p.footer_section === 'partners');
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-muted-foreground text-sm">
                ...
                <a href="tel:+923167523434" className="hover:text-background transition-colors">+923167523434</a>
              </li>
