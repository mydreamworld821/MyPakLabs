      ...
      <section className="pt-20 bg-gradient-to-br from-primary via-primary to-primary/80 text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-10 md:py-16 relative z-10 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 max-w-3xl leading-tight">
            <span className="bg-gradient-to-r from-yellow-300 via-orange-300 to-yellow-400 bg-clip-text text-transparent drop-shadow-lg">MyPakLabs</span> — Find Doctors, Labs & Hospitals Near You, Quickly and Hassle-Free
          </h1>
