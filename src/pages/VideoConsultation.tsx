...
import { Search, MapPin, Video, Stethoscope, Users } from "lucide-react";
  ...
  useEffect(() => {
    const fetchSpecializations = async () => {
      try {
        ...
        // Fetch doctor counts for each specialization (only video consultation enabled)
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-center">
              Consult Online with PMC Verified Doctors
            </h1>
          </div>
          <p className="text-center text-white/90 mb-8 max-w-lg mx-auto">
            Get expert medical advice from the comfort of your home. Video consultations available 24/7.
          </p>
