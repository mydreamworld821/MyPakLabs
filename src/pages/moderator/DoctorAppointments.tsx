...
const ModeratorDoctorAppointments = () => {
    ...
    <ModeratorLayout>
      <div className="p-4 lg:p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Review and confirm doctor appointment bookings</p>
        </div>
                ...
                <CardContent className="space-y-2">
                  <div className="flex items-center gap-3 mb-3">
                    {selectedAppointment.doctors?.photo_url ? (
                      <img src={selectedAppointment.doctors.photo_url} alt="" className="w-12 h-12 rounded-full object-cover" />
                    ) : (
                    ...
                    <div>
                      <p className="font-medium">{selectedAppointment.doctors?.full_name}</p>
                      <p className="text-sm text-muted-foreground">{selectedAppointment.doctors?.qualification}</p>
                    </div>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Specialization</span>
                    <span className="font-medium">{selectedAppointment.doctors?.doctor_specializations?.name || "-"}</span>
                  </div>
                  {selectedAppointment.doctors?.clinic_name && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Clinic</span>
                      <span className="font-medium">{selectedAppointment.doctors.clinic_name}</span>
                    </div>
                  )}
                  {selectedAppointment.doctors?.phone && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Phone</span>
                      <span className="font-medium">{selectedAppointment.doctors.phone}</span>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{format(new Date(selectedAppointment.appointment_date), "EEEE, dd MMM yyyy")}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-primary">Rs. {selectedAppointment.fee.toLocaleString()}</span>
                  </div>
...
export default ModeratorDoctorAppointments;
