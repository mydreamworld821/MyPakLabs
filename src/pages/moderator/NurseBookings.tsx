    ...
    <ModeratorLayout>
      <div className="p-4 lg:p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Review and confirm nursing service bookings</p>
        </div>
                ...
                <CardContent className="space-y-2">
                  <div className="flex items-center gap-3 mb-3">
                    {selectedBooking.nurses?.photo_url ? (
                      <img src={selectedBooking.nurses.photo_url} alt="" className="w-12 h-12 rounded-full object-cover" />
                    ) : (
                    ...
                    <div>
                      <p className="font-medium">{selectedBooking.nurses?.full_name}</p>
                      <p className="text-sm text-muted-foreground">{selectedBooking.nurses?.qualification}</p>
                    </div>
                  </div>
                  {selectedBooking.nurses?.city && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">City</span>
                      <span className="font-medium">{selectedBooking.nurses.city}</span>
                    </div>
                  )}
                  {selectedBooking.nurses?.phone && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Phone</span>
                      <span className="font-medium">{selectedBooking.nurses.phone}</span>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{format(new Date(selectedBooking.preferred_date), "EEEE, dd MMM yyyy")}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {selectedBooking.notes && (
                    <div className="pt-2">
                      <span className="text-muted-foreground block mb-1">Patient Notes</span>
                      <p className="text-sm bg-muted p-2 rounded">{selectedBooking.notes}</p>
                    </div>
                  )}
                  {selectedBooking.nurse_notes && (
                    <div className="pt-2">
                      <span className="text-muted-foreground block mb-1">Nurse Notes</span>
                      <p className="text-sm bg-muted p-2 rounded">{selectedBooking.nurse_notes}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
...
export default ModeratorNurseBookings;
