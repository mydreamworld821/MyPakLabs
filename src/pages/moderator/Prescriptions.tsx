      ...
      <div className="p-6 lg:p-8">
                  ...
                  <TableBody>
                    {filteredPrescriptions.map((prescription) => (
                      <TableRow key={prescription.id}>
                        ...
                        <TableCell>
                          {prescription.labs?.name || "Not assigned"}
                        </TableCell>
                        <TableCell>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-4">
                  ...
                  {selectedPrescription.profiles && (
                    <div className="p-3 bg-muted rounded-lg">
                      ...
                      <p className="text-sm">{selectedPrescription.profiles.full_name || "N/A"}</p>
                      <p className="text-xs text-muted-foreground">{selectedPrescription.profiles.phone || "N/A"}</p>
                    </div>
                  )}
                  ...
                  {!selectedPrescription.lab_id && (
                    <div className="p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                      <p className="text-sm text-yellow-600">
                        No lab assigned. Prices will be set to 0.
                      </p>
                    </div>
                  )}
                      ...
                      {filteredTests.length === 0 ? (
                        ...
                        <div className="divide-y">
                          {filteredTests.map(test => {
                            ...
                            const displayPrice = labPrice?.discounted_price ?? labPrice?.price ?? 0;
                              ...
                              >
                                <Checkbox
                                  ...
                                  onCheckedChange={(checked) => 
                                    handleTestToggle(test, checked as boolean)
                                  }
                                />
                                <label
                                  htmlFor={test.id}
                                ...
                                <span className={`text-sm font-medium ${hasPrice ? 'text-green-600' : 'text-muted-foreground'}`}>
                                  {hasPrice ? `Rs. ${displayPrice}` : 'No price'}
                                </span>
                              </div>
                            );
                          })}
            ...
            {/* Action Buttons */}
            {selectedPrescription && selectedPrescription.status === 'pending_review' && (
...
export default ModeratorPrescriptions;
